      ...
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            ...
            <a class="card-footer text-white clearfix small z-1" href="Asistencias.aspx">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw fas fa-leanpub"></i>
              </div>
              <div class="mr-5">Clases</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="Clases.aspx">
              <span class="float-left">Detalles</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw  fas fa-bullseye "></i>
              </div>
              <div class="mr-5">Torneos</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="Torneos.aspx">
              <span class="float-left">Detalles</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
